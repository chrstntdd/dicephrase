...
describe.concurrent("combine_zip", () => {
...
describe.concurrent("make_wl_keys", () => {
  ...
  test("should return a list where each entry is a 5 digit number", () => {
    let count = 10
    let out = make_wl_keys(count)
...
describe.concurrent("parse_count_val", () => {
  test("should return the value as a number if it exists", () => {
    let out = parse_count_val("3")
    expect(out).toEqual(3)
  })

  test("should return the fallback count if there is an error", () => {
...
describe.concurrent("parse_qs_to_phrase_config", () => {
  test("works with known values", () => {
  ...
  test("ignores out of bounds count values — returning the default", () => {
  ...
  test("ignores unknown separator values — returning the default", () => {
  ...
  test("ignores unknown query params and returns the default", () => {
...
describe.concurrent("make_separators", () => {
  ...
  test("should return an array of length 1 less than the count to splice between the words", () => {
    let count = 8
    let out = make_separators("random", count)
  ...
  test('Should return an array of identical chars when not "random"', () => {
    let count = 6
    let sep = "~"
