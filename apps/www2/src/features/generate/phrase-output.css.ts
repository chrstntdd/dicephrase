...
export const visuallyHiddenOutput = style({
	clip: "rect(0 0 0 0)",
	clipPath: "inset(50%)",
	height: "1px",
	overflow: "hidden",
...
export const visualOutputContainer = style({
	...LIST_RESET,
	display: "flex",
	flexWrap: "wrap",
	overflow: "hidden",
...
globalStyle(`${visualOutputContainer} > *`, {
	overflow: "hidden",
	whiteSpace: "nowrap",
})
globalStyle(`${visualOutputContainer} > * > *`, {
...
globalStyle(`${visualOutputContainer} > * > *[data-sep]`, {
