...
export function makeToast(msg: string, showTime: number) {
...
export function addToast(toast: HTMLElement, toastContainer: HTMLElement) {
...
export async function toastWrapper(props: {
	msg: string
	/** @description How long (in ms) the Toast should display for. Default is 3000 */
	showTime?: number
}) {
	// Defined in the index.html
	toastContainer ||= document.getElementById("app-toast-group") as HTMLElement
