...
function About() {
	return (
		<section class={/*@once*/ styles.aboutPage}>
			<h1>About</h1>
			<p class={/*@once*/ styles.tagline}>
			...
			<p>
				...
				<a href="https://developer.mozilla.org/en-US/docs/Web/API/Crypto/getRandomValues">
					<code class={/*@once*/ styles.inlineCode}>
			...
			<footer class={/*@once*/ styles.appFooter}>
				<a
					class={/*@once*/ styles.sourceLink}
					aria-label="View source on GitHub"
					href="https://github.com/chrstntdd/dicephrase"
				>
					<svg
						class={/*@once*/ styles.ghLogo}
						clip-rule="evenodd"
						fill-rule="evenodd"
