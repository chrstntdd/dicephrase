...
export declare const make_phrases: <T1>(count: number, wlRecord: Js_Dict_t<T1>) => t<T1>;
export declare const make_separators: (separator_kind: string, count: number) => string[];
